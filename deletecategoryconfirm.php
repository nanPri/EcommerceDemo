...
<?php
 ...
 <p><?php if($count>0){
	 echo "Warning! There are".$count."stock item(s) in this category.If you delete the category they will also removed from the database "; 
 }?></p>
 <p><?phpecho "DO you really wish to delete  ".$delcat_rs['name']."?"; ?></p>
